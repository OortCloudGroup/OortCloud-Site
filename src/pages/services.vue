<template>
  <div class="page_container">
    ...
    <div class="panel_wrapper">
      ...
      <SolutionAppPanel :data="policeApp"/>
      <SolutionAppPanel :data="policeStationApp"/>
      <SolutionAppPanel :data="procuratorialApp"/>
      <SolutionAppPanel :data="prisonApp"/>
      <SolutionAppPanel :data="courtApp"/>
      <SolutionAppPanel :data="fireProtApp"/>
      <SolutionAppPanel :data="filesApp"/>
      <SolutionAppPanel :data="govermentApp"/>
      <SolutionAppPanel :data="borderDefendApp"/>
      <SolutionAppPanel :data="cityAdminApp"/>
      <SolutionAppPanel :data="trafficPoliceApp"/>
      <SolutionAppPanel :data="enterpriseApp"/>
      <SolutionAppPanel :data="emergencyApp"/>
      <SolutionAppPanel :data="plaguePrevApp"/>
      <SolutionAppPanel :data="iotApp"/>
      <SolutionAppPanel :data="customizeApp"/>
      <SolutionAppPanel :data="overseasApp"/>
    </div>
...
const policeApp = ref({
  ...
  apps: [
    ...
    {
      name: '群防群治',
      logo: '/img/app/qfqz.png',
      excerpt: '“互联网+”大数据思维下建立的公安与群众的连接器'
    },
    {
      name: '为民服务',
      logo: '/img/app/wmfw.png',
      excerpt: '公安政务服务“一网通办”'
    },
    {
      name: '基层民警一体化工作平台',
      logo: '/img/app/mjyth.png',
      excerpt: '图查要素，屏观态势，打造警务信息化基石'
    },
    {
      name: '社区警务',
      logo: '/img/app/sqjw.png',
  ...
  apps: [
    {
      ...
      excerpt: '华为IdeaHub智慧屏+奥尔特云警务应用平台'
    },
    {
      name: '基层民警一体化工作平台',
      logo: '/img/app/mjyth.png',
      excerpt: '图查要素，屏观态势，打造警务信息化基石+奥尔特云警务应用平台'
    },
    {
      name: '调度指挥一张图',
      logo: '/img/app/zhyzt.png',
      excerpt: '指挥调度，警情、警力、现场、调度、过程可视'
    },
    {
      name: '枪弹装备室',
      logo: '/img/app/qd.png',
...
const prisonApp = ref({
  ...
  apps: [
    {
      name: '狱警通',
      logo: '/img/app/yjt.png',
      excerpt: '私有化部署的内网“微信”APP'
    },
    {
      name: '智慧监狱应用',
      logo: '/img/app/zhjy.png',
      excerpt: '智慧监狱业务应用'
    },
    {
      name: '惠警应用',
...
const fireProtApp = ref({
  ...
  apps: [
    {
      name: '消防指挥调度',
      logo: '/img/app/xfzhdd.png',
      excerpt: '指挥调度，警情、警力、现场、调度、过程可视'
    },
    {
      name: '消防战训管理',
      logo: '/img/app/xfzxgl.png',
      excerpt: '消防战训管理'
    }
  ]
})
...
const govermentApp = ref({
  ...
  apps: [
    {
      name: '一网协同',
      logo: '/img/app/ywxt.png',
      excerpt: '政府运行“一网协同”'
    },
    {
      name: '一网统管',
      logo: '/img/app/ywtg.png',
      excerpt: '政府治理“一网统管”'
    },
    {
      name: '一网通办',
      logo: '/img/app/ywtb.png',
      excerpt: '政务服务“一网通办”，智慧互联网+服务助手平台'
    },
    {
      name: '大数据IOC可视化',
      logo: '/img/app/ioc.png',
      excerpt: '数据可视化决策支持'
    },
    {
      name: '公务出行',
...
const borderDefendApp = ref({
  ...
  apps: [
    ...
    {
      name: '综合预警',
      logo: '/img/app/zhyj.png',
      excerpt: '移动端千万级消息推送平台'
    },
    {
      name: '可视化指挥',
      logo: '/img/app/kshzh.png',
      excerpt: '雷视一体化可视融合指挥'
    },
    {
      name: '指挥控制',
...
const cityAdminApp = ref({
  ...
  apps: [
    {
      name: '智慧城管平台',
      logo: '/img/app/zhcg.png',
      excerpt: '智慧城管大数据云平台'
    },
    {
      name: '综合行政执法平台',
      logo: '/img/app/zhxz.png',
      excerpt: '智慧城管综合行政执法平台'
    }
  ]
})
// 交警
  ...
  apps: [
    {
      ...
      excerpt: '基层社会治理可视化指挥调度一张图系统和智慧社区综合信息平台'
    },
    {
      name: '疫情防控访客管理',
      logo: '/img/app/yqfk.png',
      excerpt: '来访预约访客管理系统'
    },
    {
      name: '疫情卡口小战士',
      logo: '/img/app/xzs.png',
      excerpt: '疫情防控卡口电子哨兵'
    }
  ]
})
  ...
  apps: [
    {
      ...
      excerpt: '面向智慧城市智能计算，智能装备，智能感知设备的物联网PaaS平台'
    },
    {
      name: '动环盒子 (4G)',
...
const customizeApp = ref({
  ...
  apps: [
    ...
    {
      name: '微信公众号维护服务',
      logo: '/img/app/wechat2.png',
      excerpt: '一站式微信公众号运维运营'
    }
  ]
})
// 海外[一带一路] English
  ...
  apps: [
    {
      ...
      logo: '/img/app/ywxt.png',
      excerpt: '即时通讯工具与小程序开发运营平台'
    },
    {
      name: '政务服务 Government Services',
      logo: '/img/app/zwfw.png',
      excerpt: '政务通办、政务协同、政务统管应用'
    }
  ]
})
