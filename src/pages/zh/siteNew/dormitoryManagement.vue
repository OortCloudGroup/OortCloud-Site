  ...
  <div class="home_page vls">
    ...
    <div class="w1380 CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          实行门禁登记制度，配备刷卡、人脸识别等核验方式，严控外来人员进入；记录学生/住户归寝、晚归、夜不归宿情况，及时联动班主任/部门负责人，保障居住人员安全。针对访客设置临时登记通道，明确访客停留时长，留存身份信息备查
        </div>
      </div>
    ...
    <div class="w1380 CloudBox ipcView  flexRowAC">
      ...
      <div class="CloudL" style="text-align: left">
        ...
        <div class="cl_d">
          定期开展宿舍安全巡查，重点排查违规用电（如大功率电器）、私拉乱接电线、存放易燃易爆物品等问题；检查消防设施（灭火器、应急灯、逃生通道）是否完好可用，发现隐患立即整改并跟踪闭环，建立排查台账留存记录
        </div>
      </div>
    </div>
    <div class="w1380 ipcView CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          负责宿舍公共区域（楼道、洗衣房、卫生间、活动室）的维护与管理，保障配套设施正常运行；合理规划公共空间使用，规范晾晒区域、垃圾分类点设置，优化居住配套服务
        </div>
      </div>
