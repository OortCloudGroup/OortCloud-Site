  ...
  <div class="home_page vls">
    ...
    <div class="w1380 CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          融合音视频对讲、语音通话、即时消息、视频会议、广播通知等多元通信方式，支持一键切换、跨方式联动（如语音通话升级为视频会议、即时消息同步会议纪要），满足不同场景沟通需求
        </div>
      </div>
    ...
    <div class="w1380 CloudBox ipcView  flexRowAC">
      ...
      <div class="CloudL" style="text-align: left">
        ...
        <div class="cl_d">
          自动记录通话日志、会议纪要、文件传输记录、设备操作日志等数据，支持按时间、人员、终端等多维度检索、导出与备份，实现通信过程全追溯，满足合规与复盘需求
        </div>
      </div>
    </div>
    <div class="w1380 ipcView CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          优化传输协议与带宽占用，实现音视频、数据低延迟传输（延迟≤200ms），搭配抗干扰技术，抑制网络波动、电磁干扰对通信质量的影响，保障复杂环境下音画同步、数据不丢失
        </div>
      </div>
