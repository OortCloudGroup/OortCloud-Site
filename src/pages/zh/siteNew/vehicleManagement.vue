  ...
  <div class="home_page vls">
    ...
    <div class="w1380 CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          实行车辆出入登记制度，区分内部车辆（刷卡、人脸识别、车牌识别）与外来车辆（登记身份信息、预约报备）；严禁无资质车辆、危险品运输车辆进入管控区域，记录车辆出入时间、事由，留存台账备查，严控出入风险
        </div>
      </div>
    ...
    <div class="w1380 CloudBox ipcView  flexRowAC">
      ...
      <div class="CloudL" style="text-align: left">
        ...
        <div class="cl_d">
          划分固定车位、临时车位、消防通道、应急车道等区域，设置清晰标识标线；引导车辆按规停放，制止乱停乱放、占用消防通道等行为；定期巡查车位使用情况，及时清理僵尸车、违规停放车辆，维护停放秩序
        </div>
      </div>
    </div>
    <div class="w1380 ipcView CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          搭载车牌自动识别系统，实现内部车辆无感通行、外来车辆快速登记；联动门禁系统，同步开启道闸，减少车辆等待时间；支持手机APP扫码通行、预约通行，提升出入便捷度
        </div>
      </div>
