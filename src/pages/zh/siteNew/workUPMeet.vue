  ...
  <div class="home_page vls">
    ...
    <div class="w1380 CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          配备工业级高清摄像头（支持红外夜视、广角拍摄、1080P及以上分辨率），适配工业区低光、逆光环境；搭配降噪麦克风与高保真扬声器，抑制环境噪音，实现清晰收音与扩音
        </div>
      </div>
    ...
    <div class="w1380 CloudBox ipcView  flexRowAC">
      ...
      <div class="CloudL" style="text-align: left">
        ...
        <div class="cl_d">
          提供有线（以太网）、无线（4G/5G、WiFi）双模部署方式，支持壁挂、立杆、嵌入式安装，适配密集楼宇墙体、工业区厂房等不同安装场景，降低部署难度
        </div>
      </div>
    </div>
    <div class="w1380 ipcView CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          支持双链路传输备份（有线+无线），当一条链路受干扰或中断时，自动切换至备用链路，确保核心场景下的通信连续性
        </div>
      </div>
