  ...
  <div class="home_page vls">
    ...
    <div class="w1380 CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          结合业务增长、人员流动、技能迭代等因素，采用定量（数据分析模型）与定性（部门调研）结合的方式，预测短期（1-2年）与长期（3-5年）人力需求，形成人力规划方案
        </div>
      </div>
    ...
    <div class="w1380 CloudBox ipcView  flexRowAC">
      ...
      <div class="CloudL" style="text-align: left">
        ...
        <div class="cl_d">
          通过简历初筛、笔试、结构化/半结构化面试、专业技能测试、背景调查等多环节，全面评估候选人的能力、素养、价值观与岗位的匹配度，确保招聘质量
        </div>
      </div>
    </div>
    <div class="w1380 ipcView CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          提炼企业核心价值观，通过文化宣导、制度落地、榜样示范等方式，将企业文化融入人力资源管理各环节，营造积极向上、协同合作的组织氛围，增强员工认同感
        </div>
      </div>
