  ...
  <div class="home_page vls">
    ...
    <div class="w1380 CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          开通线上（APP、微信小程序、服务热线）、线下（物业服务中心）双渠道报修入口，支持文字、图片、视频上传故障情况，明确报修内容、地点、联系方式，确保信息精准同步，方便业主快速提交需求
        </div>
      </div>
    ...
    <div class="w1380 CloudBox ipcView  flexRowAC">
      ...
      <div class="CloudL" style="text-align: left">
        ...
        <div class="cl_d">
          覆盖住宅及公共区域基础设施维修，包括水电维修（水管漏水、电路短路、灯具更换）、门窗维修（五金件损坏、密封胶老化、玻璃更换）、墙面地面维修（裂缝、脱落、瓷砖松动）、暖通设备维修（空调、暖气、通风系统故障）等，确保设施正常使用
        </div>
      </div>
    </div>
    <div class="w1380 ipcView CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          针对突发故障（如管道爆裂、大面积断电、消防设施异常、台风暴雨后设施损毁），建立应急抢修团队，配备应急物资与工具，24小时待命；接到应急报修后快速抵达现场，采取临时处置措施控制事态，后续彻底修复，减少业主损失
        </div>
      </div>
