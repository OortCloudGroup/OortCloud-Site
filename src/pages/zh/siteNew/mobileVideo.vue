  ...
  <div class="home_page vls">
    ...
    <div class="w1380 CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          语音转文字自动生成字幕，支持多语言识别、字幕样式修改。自动优化低光环境下的画面亮度、清晰度，支持4K/1080P等多分辨率导出，兼顾画质与存储占用
        </div>
      </div>
    ...
    <div class="w1380 CloudBox ipcView  flexRowAC">
      ...
      <div class="CloudL" style="text-align: left">
        ...
        <div class="cl_d">
          基于用户兴趣标签、地理位置、观看习惯，实现视频智能推荐，助力内容触达目标人群
        </div>
      </div>
    </div>
    <div class="w1380 ipcView CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          提供免费/付费云存储空间，自动同步草稿与已发布作品，跨设备（手机、平板）同步查看，避免视频丢失
        </div>
      </div>
